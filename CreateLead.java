...
driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Keertana");

//locate lastname and type the lastname
driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Boopathy");

//locate the company name and type the company name
driver.findElement(By.id("createLeadForm_companyName")).sendKeys("CTS");

//locate the title and type the title
driver.findElement(By.name("generalProfTitle")).sendKeys("Creating a lead");
